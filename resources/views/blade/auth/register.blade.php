...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100">
        <div class="flex min-h-screen">
            ...
            <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-green-600 to-blue-700">
                <div class="flex items-center justify-center w-full">
                    <div class="text-center text-white">
                        <h1 class="text-4xl font-bold mb-4">{{ config('app.name', 'Laravel') }}</h1>
                        <p class="text-xl opacity-90">Join our community</p>
                        <div class="mt-8">
                            <div class="flex justify-center space-x-4">
                                @if(config('kaely-auth.oauth.providers.google.enabled'))
                                ...
                                @endif
                                @if(config('kaely-auth.oauth.providers.facebook.enabled'))
                                    <div class="bg-white bg-opacity-20 rounded-lg p-3">
                                ...
                                @endif
                                @if(config('kaely-auth.oauth.providers.github.enabled'))
                                    <div class="bg-white bg-opacity-20 rounded-lg p-3">
                                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
