<div class="min-h-screen bg-gray-100">
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-purple-700">
            <div class="flex items-center justify-center w-full">
                <div class="text-center text-white">
                    <h1 class="text-4xl font-bold mb-4">{{ config('app.name', 'Laravel') }}</h1>
                    <p class="text-xl opacity-90">Advanced Authentication System</p>
                    <div class="mt-8">
                ...
                <form wire:submit.prevent="login" class="mt-8 space-y-6">
                    <div class="rounded-md shadow-sm -space-y-px">
                        ...
                        <div class="relative">
                            ...
                            <input id="password" wire:model="password" type="{{ $showPassword ? 'text' : 'password' }}" autocomplete="current-password" required 
