        ...
        <div class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
            <div class="max-w-md w-full space-y-8">
                ...
                @if(config('kaely-auth.oauth.enabled'))
                    <div class="space-y-3">
                        @if(config('kaely-auth.oauth.providers.google.enabled'))
                            <button wire:click="redirectToOAuth('google')" 
                        ...
                        @if(config('kaely-auth.oauth.providers.facebook.enabled'))
                            <button wire:click="redirectToOAuth('facebook')" 
                                    class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
                        ...
                        @if(config('kaely-auth.oauth.providers.github.enabled'))
                            <button wire:click="redirectToOAuth('github')" 
                                    class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
                ...
                <form wire:submit.prevent="register" class="mt-8 space-y-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="password" wire:model="password" type="{{ $showPassword ? 'text' : 'password' }}" autocomplete="new-password" required 
                                ...
                                <button type="button" wire:click="togglePassword" 
                                    ...
                                    @if($showPassword)
                                        <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l9.242-9.242M9.878 9.878L3 3m6.878 6.878L21 21" />
                                        </svg>
                                    @else
                                        <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="password_confirmation" wire:model="password_confirmation" type="{{ $showPasswordConfirmation ? 'text' : 'password' }}" autocomplete="new-password" required 
